...
const Actions = ({ docId, totalLikes, likedPhoto, handleFocus }) => {
	...
	return (
		<section className='flex flex-col w-full mt-1 px-4'>
			<div className='flex'>
				<svg
					...
					stroke='currentColor'
					tabIndex={0}
					className={`w-8 mr-4 select-none cursor-pointer focus:outline-none block box-content ${
				...
				<svg
					onClick={handleFocus}
					onKeyDown={(event) => event === 'Enter' && handleFocus()}
